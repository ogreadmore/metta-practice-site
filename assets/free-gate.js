(function () {
  ...
  var SESSION_KEY = "metta-free-library-access-v1";
  ...
  function writeSession() {
    try {
      ...
      window.sessionStorage.setItem("metta-preview-access-v1", PASSWORD_HASH);
    } catch (_) {}
  }
  ...
  function clearSession() {
    try {
      ...
      window.sessionStorage.removeItem("metta-preview-access-v1");
    } catch (_) {}
  }
  ...
  function addStatusControl() {
    ...
    status.innerHTML =
      '<span>Private library</span><span aria-hidden="true">·</span>' +
  ...
  function showGate() {
    ...
    gate.innerHTML =
      '<div class="metta-preview-panel">' +
        ...
        '<form id="metta-preview-form" novalidate>' +
          ...
          '<button class="metta-preview-submit" type="submit">Open the free library</button>' +
    ...
    form.addEventListener("submit", async function (event) {
      ...
      error.textContent = "";
      if (!password.value) {
        error.textContent = "Enter the library password.";
        password.focus();
        return;
      }
      ...
      try {
        ...
        button.textContent = "Open the free library";
      }
    });
